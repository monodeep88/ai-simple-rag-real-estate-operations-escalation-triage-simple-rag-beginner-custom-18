...
This is a Beginner **Simple RAG** project for **Real Estate Operations Escalation Triage Simple RAG - Beginner Custom 18**. It demonstrates a React user interface, FastAPI backend, retrieval/workflow pipeline, stored run history, Docker setup, and tests.
